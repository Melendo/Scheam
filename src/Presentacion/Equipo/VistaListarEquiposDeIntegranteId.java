...
public class VistaListarEquiposDeIntegranteId extends JFrame implements IGUI {
	...
	public VistaListarEquiposDeIntegranteId() {
		setMinimumSize(new Dimension(670, 250));
		vListarEquiposDeIntegranteId();
	}
	
	public void vListarEquiposDeIntegranteId() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(VistaListarEquiposDeIntegranteId.class.getResource("/icons/cliente.png")));

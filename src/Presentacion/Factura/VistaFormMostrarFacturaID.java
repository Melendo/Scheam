...
public class VistaFormMostrarFacturaID extends JFrame implements IGUI {
	...
	public VistaFormMostrarFacturaID () {
		vFormMostrarFacturaID();
	}

	public void vFormMostrarFacturaID() {
		setMinimumSize(new Dimension(500, 360));
		setTitle("Mostrar Factura por ID");
		setIconImage(Toolkit.getDefaultToolkit().getImage(VistaFormMostrarFacturaID.class.getResource("/icons/generales/listar_uno-removebg-preview.png")));
		...
		logo.setIcon(new ImageIcon(new ImageIcon(VistaFormMostrarFacturaID.class.getResource("/icons/generales/listar_uno-removebg-preview.png")).getImage().getScaledInstance(50, 50, java.awt.Image.SCALE_SMOOTH)));
		titlepanel.add(logo);

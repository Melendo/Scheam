...
public class VistaBajaTarea extends JFrame implements IGUI{
	...
	public VistaBajaTarea() {
		vBajaTarea();
	}

	public void vBajaTarea() {
		setMinimumSize(new Dimension(500, 360));
		setTitle("Baja Tarea");
		setIconImage(Toolkit.getDefaultToolkit().getImage(VistaBajaTarea.class.getResource("/icons/generales/baja-removebg-preview.png")));
		...
		JLabel logo = new JLabel("      Baja Tarea");
		logo.setFont(new Font("Tahoma", Font.BOLD, 25));
		logo.setIcon(new ImageIcon(new ImageIcon(VistaBajaTarea.class.getResource("/icons/generales/baja-removebg-preview.png")).getImage().getScaledInstance(50, 50, java.awt.Image.SCALE_SMOOTH)));
		titlepanel.add(logo);
	...
	private void ok() {
		...
		Controlador.getInstance().update(Eventos.BajaTarea, id_empleado);
		if (cerrar) 
			dispose();
		 else 
			cerrar = true;
	...
	public void update(int event, Object object) {
		...
		case Eventos.BajaTareaNoOK:
			...
			cerrar = false;
			break;
		case Eventos.BajaTareaNoOK2:
			JOptionPane.showMessageDialog(null, "Error al dar de Baja. Tarea ya dada de Baja");
			cerrar = false;
			break;
		}

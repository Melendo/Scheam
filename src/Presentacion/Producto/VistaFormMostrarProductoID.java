...
public class VistaFormMostrarProductoID extends JFrame implements IGUI{
	...
	public VistaFormMostrarProductoID () {
		vFormMostrarProductoID();
	}
	...
	private void ok() {
		int idemproducto = Integer.parseInt(idtextfield.getText());
		Controlador.getInstance().update(Eventos.MostrarProductoID, idemproducto);
		if (cerrar)
			dispose();
		else
			cerrar = true;
